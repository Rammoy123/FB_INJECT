...
// // if (flag===0)
// {
 // <div class="make_it_cursive" style="background: black; cursor: pointer;">C</div>`
...
const textFormatOption = (type) => {
  ...
  if ($(`[aria-label="Post"]`).length) {
    ...
    if (stringSelected) {
      ...
      //   case 0:
      //     // code block
      //     reformatedText = stringSelected.replace(/[A-Za-z0-9]/g, translateBold);
      //     break;
      //   case 1:
      //     reformatedText = stringSelected.replace(/[A-Za-z0-9]/g, translateItalic);
      //     // code block
      //     break;
      //   default:
      //     reformatedText = stringSelected.replace(/\u[𝗔𝗕𝗖𝗗𝗘𝗙𝗚𝗛𝗜𝗝𝗞𝗟𝗠𝗡𝗢𝗣𝗤𝗥𝗦𝗧𝗨𝗩𝗪𝗫𝗬𝗭𝗯𝗰𝗱𝗲𝗳𝗴𝗵𝗶𝗷𝗸𝗹𝗺𝗻𝗼𝗽𝗾𝗿𝘀𝘁𝘂𝘃𝘄𝘅𝘆𝘇𝟭𝟮𝟯𝟰𝟱𝟲𝟳𝟴𝟵𝟬]/g, translateDefault);
          
      //     // code block
      // }
      var reformatedText = reformatIt(stringSelected, type);
      // var reformatedText = stringSelected.replace(/[A-Za-z]/g, translate);
      ...
      navigator.clipboard.write(cpData).then(
        function () {
          ...
          restoreSelection(selectedObj);
          console.log(selectedObj.toString(),"lolllllllll");
        },
        function (error) {
